...
})({"8a7d5a4c3d5aaa4210a70c66a68626a8":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";
module.bundle.HMR_BUNDLE_ID = "10e2957490384f91c3846142cbb378a7";
...
// let htmlOutput = document.getElementById('progOutput');
// let h2: HTMLHeadingElement = document.createElement('h2');
// let h2Text: Text = document.createTextNode('Soccer');
// h2.appendChild(h2Text);
// htmlOutput?.appendChild(h2);
...
// let leagueDropDown = document.getElementById('leagueMenu');
// let reset: HTMLButtonElement | null = document.querySelector('#delete');
...
//   const teamData = r.data.api.teams;
...
// )
// .then((r: AxiosResponse) => {
//   const leagueData = r.data.api.leagues;
//   for (let league of leagueData) {
//     let menuItem = new Option(league.name);
...
// });
// let playerMenu:HTMLInputElement | null = document.querySelector('#playerMenu');
let playerURL = 'https://api-football-v1.p.rapidapi.com/v2/players/player/253';

_axios.default.get(playerURL, {
  headers: {
    'x-rapidapi-key': '931d9b8699msh29048597dd34220p154740jsn5430bcc54bb6',
    'x-rapidapi-host': 'api-football-v1.p.rapidapi.com'
  }
}).then(r => {
  const playerNames = r.data.api.data.player_name;
...
},{}]},{},["8a7d5a4c3d5aaa4210a70c66a68626a8","8ff988b981d62ba0f5af31d8720616e2"], null)

//# sourceMappingURL=main.10e29574.js.map
